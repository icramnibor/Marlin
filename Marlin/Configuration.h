...
#define STRING_CONFIG_H_AUTHOR "(icramnibor, Ender-3 Pro)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -51, -12, -1.085 }
...
// Require minimum nozzle and/or bed temperature for probing - regiben nem volt
...
#define LEVEL_BED_CORNERS
  ...
  //#define LEVEL_CORNERS_USE_PROBE       //regiben nem volt
...
#define PREHEAT_2_LABEL       "ABS"      //masik filament
...
//#define NOZZLE_CLEAN_FEATURE
  ...
  // Require a minimum hotend temperature for cleaning regiben nem volt
