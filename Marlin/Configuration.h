...
#define STRING_CONFIG_H_AUTHOR "(icramnibor, Ender-3 Pro)" // Original author or contributor.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_V2_0_REV_B  // BigTreeTech SKR V2.0 Rev B
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -51, -12, -1.085 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
